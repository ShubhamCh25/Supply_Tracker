...
contract ProductRegistry {
    ...
    function buyProduct(uint256 tokenId, address customerAddress) public {
        ...
        require(products[tokenId].manufacturer == msg.sender || msg.sender == address(this), "Not authorized");
        
        address manufacturer = products[tokenId].manufacturer;
        
        // Transfer NFT from manufacturer to customer
        productNFT.transferProduct(tokenId, customerAddress);
        
        // Mark as unavailable
        products[tokenId].available = false;
        
        emit ProductPurchased(tokenId, customerAddress, manufacturer);
    }
    ...
    function getProductsByOwner(address owner) public view returns (uint256[] memory) {
        ...
        // Create array of owned products
